...
| prepare                                     | _Function_  | `undefined` | Called after the script is initialized when the image is scaled and fit into the container. Gets an instance `WZoom` as the first argument.                                                                                                                                                           |
| rescale                                     | _Function_  | `undefined` | Called on every change of scale. Gets an instance `WZoom` as the first argument.                                                                                                                                                                                                                      |
...
| dragScrollableOptions<br/>.onGrab           | _Function_  | `undefined` | Called after grabbing an element.                                                                                                                                                                                                                                                                     |
| dragScrollableOptions<br/>.onMove           | _Function_  | `undefined` | Called on every tick when moving element.                                                                                                                                                                                                                                                             |
| dragScrollableOptions<br/>.onDrop           | _Function_  | `undefined` | Called after dropping an element.                                                                                                                                                                                                                                                                     |
