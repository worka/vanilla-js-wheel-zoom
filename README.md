...
| smoothTime                            | _Number_    | `.3`        | Time of smooth extinction. if `0` then no smooth extinction. Disabled for touch devices. (value in seconds)                                                                                                                                                                                          |
...
|                                       |             |             |                                                                                                                                                                                                                                                                                                      |
| dragScrollableOptions<br/>.smoothTime | _Number_    | `.25`       | Time of smooth extinction. if `0` then no smooth extinction. Disabled for touch devices. (value in seconds)                                                                                                                                                                                          |
